...
# TODO: Implement a simple learning rule module (e.g., delta rule). LABELS:learning,enhancement ASSIGNEE:diogoribeiro7
# TODO: Add tests for learning rules (unit + seeded Monte Carlo). LABELS:learning,tests ASSIGNEE:diogoribeiro7
